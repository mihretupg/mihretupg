...
function Hero() {
  return (
    <section id="home" className="relative overflow-hidden bg-navy-950 pt-28 text-resume-paper lg:pt-32">
      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-72px)] max-w-7xl items-center gap-12 px-5 pb-24 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
        <div className="max-w-3xl">
          <div className="mb-6 inline-flex items-center gap-2 rounded-lg border border-accent-300/40 bg-resume-paper/10 px-3 py-2 text-sm text-resume-paper">
            <MapPin size={16} />
            {personal.location}
          </div>
          <h1 className="text-4xl font-bold leading-tight text-resume-paper sm:text-5xl lg:text-6xl">{personal.name}</h1>
          <p className="mt-5 text-xl font-semibold text-accent-100 lg:text-2xl">{personal.title}</p>
          <p className="mt-6 max-w-2xl text-base leading-8 text-resume-line">{personal.summary}</p>
